...
if 1:
    ...
    metrics       = [metric_base.fid2k]                                                   # Options for MetricGroup.
    ...
    desc += '-chairs_128_edited';     dataset = EasyDict(tfrecord_dir='chairs_128_edited', resolution=128); train.mirror_augment = False
    ...
    #desc += '-lamps_128';     dataset = EasyDict(tfrecord_dir='lamps_128', resolution=128); train.mirror_augment = False
    #desc += '-cars_128';     dataset = EasyDict(tfrecord_dir='cars_128', resolution=128); train.mirror_augment = False
    #desc += '-chairs_tables';     dataset = EasyDict(tfrecord_dir='chairs_tables', resolution=128); train.mirror_augment = False
    ...
    sched.G_lrate_dict = {128: 0.001} #{128: 0.0015, 256: 0.002, 512: 0.003, 1024: 0.003}
