...
def training_loop(
    ...
    resume_snapshot         = 11609,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 11609.6,      # Assumed training progress at the beginning. Affects reporting and training schedule.
