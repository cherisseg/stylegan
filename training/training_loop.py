...
def training_loop(
    ...
    resume_snapshot         = 5486,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 5486.2,      # Assumed training progress at the beginning. Affects reporting and training schedule.
