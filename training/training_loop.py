...
def training_loop(
    ...
    resume_snapshot         = 5306  ,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 5306.1,      # Assumed training progress at the beginning. Affects reporting and training schedule.
