...
def training_loop(
    ...
    resume_snapshot         = 13590,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 13590.7,      # Assumed training progress at the beginning. Affects reporting and training schedule.
