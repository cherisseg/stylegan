...
def training_loop(
    ...
    resume_snapshot         = 6526,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 6526.1,      # Assumed training progress at the beginning. Affects reporting and training schedule.
