...
def training_loop(
    ...
    resume_snapshot         = 4705,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 4705.8,      # Assumed training progress at the beginning. Affects reporting and training schedule.
