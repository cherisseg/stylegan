...
def training_loop(
    ...
    resume_snapshot         = 8487,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 8487.9,      # Assumed training progress at the beginning. Affects reporting and training schedule.
