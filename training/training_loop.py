...
def training_loop(
    ...
    resume_run_id           = 12,     # Run ID or network pkl to resume training from, None = start from scratch.
    resume_snapshot         = 4085,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 4085.5,      # Assumed training progress at the beginning. Affects reporting and training schedule.
