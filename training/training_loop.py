...
def training_loop(
    ...
    resume_snapshot         = 9268 ,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 9268.3,      # Assumed training progress at the beginning. Affects reporting and training schedule.
