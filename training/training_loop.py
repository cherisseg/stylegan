...
def training_loop(
    ...
    resume_snapshot         = 7287,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 7287.2,      # Assumed training progress at the beginning. Affects reporting and training schedule.
