...
def training_loop(
    ...
    resume_snapshot         = 9448,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 9448.4,      # Assumed training progress at the beginning. Affects reporting and training schedule.
