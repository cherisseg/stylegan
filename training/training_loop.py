...
def training_loop(
    ...
    resume_snapshot         = 6506,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 6506.8,      # Assumed training progress at the beginning. Affects reporting and training schedule.
