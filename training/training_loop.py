...
def training_loop(
    ...
    resume_snapshot         = 7467,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 7467.3,      # Assumed training progress at the beginning. Affects reporting and training schedule.
