...
def training_loop(
    ...
    resume_snapshot         = 7887 ,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 7887.5,      # Assumed training progress at the beginning. Affects reporting and training schedule.
